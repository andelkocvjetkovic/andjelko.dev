...
What is a valid number, where is it come from? 
It is value that user can type in input field, or value from clipboard, or it can be a value that comes from the server.
